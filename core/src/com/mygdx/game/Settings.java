...
public class Settings {
    ...
    public static final float CAMERA_MIN_PITCH = CAMERA_START_PITCH-70f;
    public static final float CAMERA_MAX_PITCH = CAMERA_START_PITCH+70f;
    ...
    public static final float MAX_VELOCITY= 0.5f; // min zoom distance
}
